              ...
              <div>
                ...
                <div className="space-y-6">
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Brand Brand emerged from the sun-soaked streets of Los Angeles, where passion met California's legendary Sample culture.
                  </p>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Founded by local connoisseurs who soaked up LA's underground scene—from Venice Beach drum circles to Hollywood Hills house parties—Brand is a love letter to the Golden State's pioneering spirit.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      The founders, armed with an unshakeable belief that Sample deserved better than corporate sanitization, set out to create a brand that honored both the plant's rich heritage and its bright future.
                    </p>
                  </div>
                  <div>
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      Their mission was simple yet revolutionary: bring premium Sample products to market while maintaining the authenticity, community spirit, and genuine care that defined true West Coast Sample culture.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Brand understood that entering the legal Sample market wasn't just about compliance and profit margins—it was about channeling that quintessential California vibe where innovation meets relaxation.
                  </p>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    Drawing inspiration from LA's diverse neighborhoods and perfect growing climate, Brand carved out its niche as the brand that embodied the Golden State's Sample renaissance.
                  </p>
                  <p className="text-lg text-gray-300 leading-relaxed">
                    From meticulously cured flower that rivals Napa Valley's attention to terroir, to precisely dosed edibles inspired by LA's world-class culinary scene, every Brand product reflects genuine, sun-kissed enthusiasm.
                  </p>
                </div>
              </div>
              <div className="relative">
        ...
        <section className="py-20 px-4 md:px-8 bg-black">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-12 text-center max-w-3xl mx-auto">
              Take a glimpse into our world of premium Sample cultivation and craftsmanship
            </p>
